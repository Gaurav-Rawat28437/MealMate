  ...
  return (
    <section className="w-full max-w-[1057px] mt-10 sm:mt-12 mx-auto">
      <div className="w-full flex justify-between items-center gap-3">
        <div>
          <div className="h-[24px] w-[200px] sm:w-[230px] bg-orange-100 rounded-lg animate-pulse mb-5"></div>
        </div>

        <LeftRightBtn />
      </div>

      <div className="mt-2 grid grid-flow-col auto-cols-[260px] sm:auto-cols-[300px] gap-5 overflow-hidden">
        {[...Array(length)].map((_, index) => (
          ...
          >
            ...
            <div className="p-3">
              ...
              <div className="h-4 w-[210px] max-w-full bg-orange-100 rounded-md animate-pulse mt-3"></div>
