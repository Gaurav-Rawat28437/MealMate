...
function HomeRestaurantLoading({length=12}) {
  return (
    <section className="w-full max-w-[1057px] mt-12 mx-auto">
        <div className="h-7 w-72 bg-orange-100 rounded-lg animate-pulse mb-6"></div>
        ...
        <div className="grid grid-cols-3 gap-7 justify-center">
          {[...Array(length)].map((_, index) => (
            ...
            >
              <div className="h-[170px] bg-orange-100 animate-pulse"></div>

              <div className="p-4">
                <div className="h-5 w-40 bg-orange-100 rounded-md animate-pulse"></div>
                <div className="h-4 w-52 bg-orange-100 rounded-md animate-pulse mt-3"></div>
