...
function CartItemCard({
    ...
    return (
        <div className="bg-white rounded-[24px] border border-orange-100 shadow-sm p-4 flex gap-4">
            <div className="h-[110px] w-[110px] rounded-2xl overflow-hidden bg-orange-50 shrink-0">
                {imageUrl ? (
                    <img
                        src={imageUrl}
                        alt={item.name}
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-4">
                    ...
                    <button
                        ...
                        className="px-4 py-2 rounded-xl border border-red-200 text-red-500 text-sm font-bold hover:bg-red-50 transition"
                    >
                        Remove
                    </button>
                </div>
