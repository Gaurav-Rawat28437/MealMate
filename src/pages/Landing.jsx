...
function LandingPage() {
  const { foodItems: foodItemsData, loading } = useSelector(
    (store) => store.foodCategory
  )
  ...
  return (
    <main className="w-full min-h-screen bg-[#FFF8F2] overflow-hidden">
      ...
      <section className="w-full px-4 sm:px-6 md:px-10 lg:px-[120px] py-14 md:py-20 bg-[#FFF8F2]">
